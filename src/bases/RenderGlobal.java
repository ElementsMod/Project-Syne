    ...
    implements IWorldAccess
{
            ...
            double d3, double d4, double d5)
    {
        ...
        if(s.equals("Element1FX"))
        {
            mc.effectRenderer.addEffect(new EntityElement1FX(worldObj, d, d1, d2, d3, d4, d5, 1.5F));
        }else
        if(s.equals("Element2FX"))
        {
            mc.effectRenderer.addEffect(new EntityElement2FX(worldObj, d, d1, d2, d3, d4, d5, 1.5F));
        }
    }
